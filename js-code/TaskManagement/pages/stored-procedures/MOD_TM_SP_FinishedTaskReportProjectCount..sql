USE [awdb]
GO
/****** Object:  StoredProcedure [dbo].[MOD_TM_SP_FinishedTaskReportProjectCount]    Script Date: 1/6/2020 11:49:00 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[MOD_TM_SP_FinishedTaskReportProjectCount]
...
AND (task.status = 3 or task.status= 12) and task.isDeleted <> 1
